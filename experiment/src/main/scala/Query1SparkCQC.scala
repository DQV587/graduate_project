...
object Query1SparkCQC {
	...
	def main(args: Array[String]): Unit = {
		...
		val v7 = v6.groupBy()
		//index structure
		val v8 = v7.sortWith[Long]((array:Array[Any])=>array(2).asInstanceOf[Int], (x: Long, y: Long) => longLessThan(x, y)).persist()
		// mf column
		val v9 = v8.getMf((array:Array[Any])=>array(2).asInstanceOf[Int])
		...
		val v15 = v14.sortWith[Long]((array:Array[Any])=>array(2).asInstanceOf[Int], (x: Long, y: Long) => longLessThan(y, x)).persist()

		val v16 = v15.getMf((array:Array[Any])=>array(2).asInstanceOf[Int])
